...
//                            ImageView view = (ImageView) findViewById(R.id.load_button);
//                            String uriString = c
//                                    .getString(c
...
//                            view.setImageURI(Uri.parse(uriString));
    ...
    {
        mTextures.add(Texture.loadTextureFromApk("black_g.jpg",
                                                 getAssets()));
        mTextures.add(Texture.loadTextureFromApk("black_g.jpg",
                                                 getAssets()));
        mTextures.add(Texture.loadTextureFromApk("black_g.jpg",
    ...
    public native int countTrackingNative();
                    ...
                    new Runnable() {
                        public void run()
                        {
                            ...
                            addContentView(mGlView, new LayoutParams(
                                            ...
                                            LayoutParams.FILL_PARENT));
                            addContentView(guiManager.getOverlayView(), new LayoutParams(
                                    LayoutParams.FILL_PARENT,
                                    LayoutParams.FILL_PARENT));
                            
                            guiManager.getOverlayView().findViewById(R.id.load_button).setOnClickListener(new OnClickListener() {
								
								@Override
								public void onClick(View v) {
									dm = (DownloadManager) getSystemService(DOWNLOAD_SERVICE);
							        Request request = new Request(
							                Uri.parse("https://dl.dropbox.com/s/6emqcdqdm09u2lg/Game%20of%20Thrones%20Violin%20Cover.mp4"));
							        enqueue = dm.enqueue(request);
							        Toast.makeText(ImageTargets.this, "Download started ...", Toast.LENGTH_SHORT).show();
								}
							});
                            guiManager.getOverlayView().setOnClickListener(ImageTargets.this);
                            guiManager.getOverlayView().setOnTouchListener(gestureListener);
...
//    }
    ...
    class MyGestureDetector extends SimpleOnGestureListener {
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
        	if (ImageTargets.this.countTrackingNative() == 0) {
        		return false;
        	}
...
//                    Toast.makeText(ImageTargets.this, "Right Swipe", Toast.LENGTH_SHORT).show();
                	Intent intent = new Intent(ImageTargets.this, TrailerViewerActivity.class);
